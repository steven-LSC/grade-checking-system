  ...
  <div>
    ...
    <div class="group">
      ...
      <select v-model="setting.scoreKey" class="primary">
        <option
          v-for="(key, index) in studentInfoKeys"
          :value="key"
          :key="index"
        >
          {{ key }}
...
export default {
  ...
  setup() {
    ...
    const setting = reactive({
      wayOfPuttingScore: 'multipleSheets',
      scoreKey: '總分', // for singleSheet
      numSheetsPerStudent: 3, // for multipleSheets
      outputKeys: ['姓名'],
      checkingType: 'scoreDiff',
      scoreGapThreshold: 10, // for scoreDiff
